...
SPACY_LANGUAGE_MODELS: dict[str, str] = {
    ...
    "de": "de_core_news_sm", "pt": "pt_core_news_sm", "it": "it_core_news_sm",
    "nl": "nl_core_news_sm", "el": "el_core_news_sm", "ja": "ja_core_news_sm",
    "zh": "zh_core_web_sm", "ru": "ru_core_news_sm", "ko": "ko_core_news_sm",
    "xx": "xx_ent_wiki_sm",
}

PRESIDIO_LANGUAGE_MAP: dict[str, str] = {
    "en": "en", "es": "es", "fr": "fr", "de": "de", "pt": "pt",
    "it": "it", "nl": "nl", "ja": "ja", "zh": "zh", "ru": "ru",
    "ko": "ko", "ar": "ar",
}
...
def _normalize_language(lang: str) -> str:
    ...
    _map = {
        ...
        "dutch": "nl", "nederlands": "nl", "japanese": "ja", "日本語": "ja",
        "chinese": "zh", "中文": "zh", "russian": "ru", "русский": "ru",
        "korean": "ko", "한국어": "ko", "arabic": "ar", "العربية": "ar",
...
def init_nlp_deidentifier(language: str = "en", quiet: bool = False):
    ...
    """
    try:
        from deidentification import Deidentification, DeidentificationConfig  # type: ignore
    except ImportError:
        if not quiet:
            print(
