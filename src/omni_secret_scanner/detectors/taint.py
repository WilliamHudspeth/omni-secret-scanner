...
PYTHON_SINKS = {
    ...
    "requests.delete", "requests.Session", "urllib.request.urlopen",
    "httpx.get", "httpx.post", "aiohttp.ClientSession",
    "subprocess.run", "subprocess.Popen", "subprocess.call",
    "os.system", "os.popen", "open", "print", "logging.info",
...
_REGEX_SINKS = [
    r"requests\.", r"urllib", r"http\.", r"httpx", r"subprocess",
    r"os\.system", r"os\.popen", r"open\(", r"logging\.",
    r"fetch\(", r"axios", r"console\.log", r"console\.error",
    r"fs\.writeFile", r"java\.net\.", r"HttpURLConnection",
    r"curl_exec", r"file_put_contents",
]
