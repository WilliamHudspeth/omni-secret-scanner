...
class CharMarkovModel:
    ...
    def train(self, corpus: str, exclude_spans: Optional[list[tuple[int, int]]] = None):
    ...
    for fp in text_files:
        try:
            ...
            safe = [
                ...
                if not re.search(_SECRET_LOOKALIKE, line)
            ]
...
import re  # needed at module level for _SECRET_LOOKALIKE
