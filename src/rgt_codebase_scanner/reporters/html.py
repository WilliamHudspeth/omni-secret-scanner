...
<title>rgt-codebase-scanner – Audit Report</title>
<style>
...
<header>
  <h1>&#x1F512; rgt-codebase-scanner v{_VERSION}</h1>
...
<footer>Generated by <strong>rgt-codebase-scanner v{_VERSION}</strong> &mdash; {now}</footer>
<script>
